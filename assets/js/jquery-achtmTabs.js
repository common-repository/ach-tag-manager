...
(function(e, t, n) {
    ...
    var r = {
        ...
        classes: {
            stateDefault: "ach-tabs-state-default",
            stateActive: "ach-tabs-state-active",
            stateDisabled: "ach-tabs-state-disabled",
            stateExcluded: "ach-tabs-state-excluded",
            tab: "ach-tabs-tab",
            anchor: "ach-tabs-anchor",
            panel: "ach-tabs-panel",
            accordionTitle: "ach-tabs-accordion-title"
        }
    };
    ...
    i.prototype._loadElements = function() {
        var t = this,
            ...
            r = [],
            i = 0;
        this.$element.addClass("ach-tabs");
        n.addClass("ach-tabs-nav");
...
jQuery(
	function(){
		...
		/* Responsive Tabs */
		jQuery( '#ach-tabs' ).show().responsiveTabs(
			{
